...
SAVE_ROOT = os.path.join(BASE_DATA_DIR, "test_results")

def run_evaluator(teams, company_id, proj_pefix) : 
    print(f"Running evaluator for teams: {teams}, company_id: {company_id}, project_id: {proj_pefix}")
    print("=" * 50)
    ...
    for team_suffix in teams : 
        ...
        for i, item in enumerate(COMMON_QUESTIONS) : 
            params = {
